...
```json
{
  "filename": "MF-DEMO-001-旅行收纳袋-main",
  "shot": "1:1 aspect ratio",
  "subject": {
    "main_product": "MF-DEMO-001, shown in full and treated as the unmistakable visual core. Preserve its exact visible shape, count, color, proportions, and construction from the product references.",
    "accessory": "旅行收纳袋, shown in full as a smaller secondary add-on. Match its reference color, material, and shape exactly. Verified accessory information: Product identifier: 旅行收纳袋 - 组合限制：没有证据证明主商品与收纳袋存在安装、连接或尺寸兼容关系，因此只允许中性旅行陈列，不表现强行装入或连接 - 未提供准确尺寸和材料信息，不得推断",
    ...
    "action": "Show the complete product as the dominant centered subject on a clean bright background with honest scale and no visual clutter. Present both items in a natural relationship rather than as an arbitrary pile.",
    "condition": "Both products are new, clean, complete, undamaged, correctly proportioned, and free from distracting packaging."
  },
  "combination_logic": "Create a credible low-noise pairing between MF-DEMO-001 and 旅行收纳袋. If their direct functional relationship is weak, use a neutral coordinated retail bundle, tidy storage, gifting, or adjacent-use presentation; never invent compatibility or functionality.",
...
```json
{
  "filename": "MF-DEMO-001-旅行收纳袋-size",
  "shot": "1:1 aspect ratio",
  "subject": {
    "main_product": "MF-DEMO-001, shown in full and treated as the unmistakable visual core. Preserve its exact visible shape, count, color, proportions, and construction from the product references.",
    "accessory": "旅行收纳袋, shown in full as a smaller secondary add-on. Match its reference color, material, and shape exactly. Verified accessory information: Product identifier: 旅行收纳袋 - 组合限制：没有证据证明主商品与收纳袋存在安装、连接或尺寸兼容关系，因此只允许中性旅行陈列，不表现强行装入或连接 - 未提供准确尺寸和材料信息，不得推断",
    ...
    "colors": "Match both reference sets exactly; do not shift accessory colors toward yellow, neon, or excessive saturation.",
    "materials": "Render only materials visibly supported by references and supplied facts, with realistic surface response.",
    "action": "Show the complete product and use precise thin measurement lines. Include only dimensions supported by the supplied product information or reference image; never guess. Present both items in a natural relationship rather than as an arbitrary pile.",
    "condition": "Both products are new, clean, complete, undamaged, correctly proportioned, and free from distracting packaging."
  },
  "combination_logic": "Create a credible low-noise pairing between MF-DEMO-001 and 旅行收纳袋. If their direct functional relationship is weak, use a neutral coordinated retail bundle, tidy storage, gifting, or adjacent-use presentation; never invent compatibility or functionality.",
  "product_information": "Product identifier: MF-DEMO-001",
...
```json
{
  "filename": "MF-DEMO-001-旅行收纳袋-lifestyle-scene",
  "shot": "1:1 aspect ratio",
  "subject": {
    "main_product": "MF-DEMO-001, shown in full and treated as the unmistakable visual core. Preserve its exact visible shape, count, color, proportions, and construction from the product references.",
    "accessory": "旅行收纳袋, shown in full as a smaller secondary add-on. Match its reference color, material, and shape exactly. Verified accessory information: Product identifier: 旅行收纳袋 - 组合限制：没有证据证明主商品与收纳袋存在安装、连接或尺寸兼容关系，因此只允许中性旅行陈列，不表现强行装入或连接 - 未提供准确尺寸和材料信息，不得推断",
  ...
  "diversity_plan": {
    ...
    "camera_angle": "45-degree side-front product-readable view",
    "composition_family": "layered depth with quiet supporting objects and no clutter",
    "daylight_direction": "soft overhead daylight plus subtle edge separation",
    "emotional_tone": "useful, trustworthy, satisfying"
  },
  "interaction_plan": {
  ...
  "environment": "Immersive but uncluttered bright neutral commercial product setting in bright daytime, expressing useful, trustworthy, satisfying. Build a familiar, attainable slice of daily life with natural spatial depth, tactile material cues, and restrained lived-in details. The complete product remains immediately readable; no person is required, and the setting must never become dark, cinematic, or more visually important than the product.",
  "composition": "layered depth with quiet supporting objects and no clutter; keep complete items inside frame with safe margins and no obstructive overlap.",
  "camera": {
    "focal_length": "50-70mm equivalent",
    "aperture": "f/8",
    "angle": "45-degree side-front product-readable view"
  },
  "lighting": "soft overhead daylight plus subtle edge separation",
  "color_grade": "Neutral, bright, realistic e-commerce grade with clean whites and restrained saturation.",
...
```json
{
  "filename": "MF-DEMO-001-旅行收纳袋-detail",
  "shot": "1:1 aspect ratio",
  "subject": {
    "main_product": "MF-DEMO-001, shown in full and treated as the unmistakable visual core. Preserve its exact visible shape, count, color, proportions, and construction from the product references.",
    "accessory": "旅行收纳袋, shown in full as a smaller secondary add-on. Match its reference color, material, and shape exactly. Verified accessory information: Product identifier: 旅行收纳袋 - 组合限制：没有证据证明主商品与收纳袋存在安装、连接或尺寸兼容关系，因此只允许中性旅行陈列，不表现强行装入或连接 - 未提供准确尺寸和材料信息，不得推断",
    ...
    "colors": "Match both reference sets exactly; do not shift accessory colors toward yellow, neon, or excessive saturation.",
    "materials": "Render only materials visibly supported by references and supplied facts, with realistic surface response.",
    "action": "Keep the entire product visible and use restrained callout lines or small insets to explain verified materials, construction, surface, attachment, or handling features. Present both items in a natural relationship rather than as an arbitrary pile.",
    "condition": "Both products are new, clean, complete, undamaged, correctly proportioned, and free from distracting packaging."
  },
  "combination_logic": "Create a credible low-noise pairing between MF-DEMO-001 and 旅行收纳袋. If their direct functional relationship is weak, use a neutral coordinated retail bundle, tidy storage, gifting, or adjacent-use presentation; never invent compatibility or functionality.",
  "product_information": "Product identifier: MF-DEMO-001",
...
```json
{
  "filename": "MF-DEMO-001-旅行收纳袋-comparison",
  "shot": "1:1 aspect ratio",
  "subject": {
    "main_product": "MF-DEMO-001, shown in full and treated as the unmistakable visual core. Preserve its exact visible shape, count, color, proportions, and construction from the product references.",
    "accessory": "旅行收纳袋, shown in full as a smaller secondary add-on. Match its reference color, material, and shape exactly. Verified accessory information: Product identifier: 旅行收纳袋 - 组合限制：没有证据证明主商品与收纳袋存在安装、连接或尺寸兼容关系，因此只允许中性旅行陈列，不表现强行装入或连接 - 未提供准确尺寸和材料信息，不得推断",
    ...
    "colors": "Match both reference sets exactly; do not shift accessory colors toward yellow, neon, or excessive saturation.",
    "materials": "Render only materials visibly supported by references and supplied facts, with realistic surface response.",
    "action": "Keep the complete product visible and compare verified states, use cases, arrangement options, included quantity, or before-and-after presentation without attacking another product. Present both items in a natural relationship rather than as an arbitrary pile.",
    "condition": "Both products are new, clean, complete, undamaged, correctly proportioned, and free from distracting packaging."
  },
  "combination_logic": "Create a credible low-noise pairing between MF-DEMO-001 and 旅行收纳袋. If their direct functional relationship is weak, use a neutral coordinated retail bundle, tidy storage, gifting, or adjacent-use presentation; never invent compatibility or functionality.",
  "product_information": "Product identifier: MF-DEMO-001",
