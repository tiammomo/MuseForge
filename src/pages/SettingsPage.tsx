  ...
  return (
    <div className="settings-page page-pad">
      ...
      <div className="settings-main">
        ...
        <section className="panel settings-section"><div className="settings-heading"><div><small>目录协议</small><h3>当前商品工作区</h3></div><button className="button secondary">打开目录 <ExternalLink size={14} /></button></div><div className="path-field"><FolderCog size={17} /><span>{workspace?.root ?? './workspace'}</span></div><div className="folder-contract"><p><span>原始商品图/</span><Check size={13} /></p><p><span>配件超市/</span><Check size={13} /></p><p><span>组合/</span><Check size={13} /></p></div></section>
